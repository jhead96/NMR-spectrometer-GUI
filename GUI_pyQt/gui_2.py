...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_2.addWidget(self.sampleTabNextBtn, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dataFileGenerateLbl, 5, 1, 1, 1)
        ...
        self.saveFileLocLbl = QtWidgets.QLabel(self.tab_sample)
        self.saveFileLocLbl.setObjectName("saveFileLocLbl")
        self.gridLayout_2.addWidget(self.saveFileLocLbl, 3, 0, 1, 1)
        self.genDataFileBtn = QtWidgets.QPushButton(self.tab_sample)
        self.genDataFileBtn.setObjectName("genDataFileBtn")
        self.gridLayout_2.addWidget(self.genDataFileBtn, 4, 1, 1, 1)
        self.SaveFileLocLineEdit = QtWidgets.QLineEdit(self.tab_sample)
        self.SaveFileLocLineEdit.setObjectName("SaveFileLocLineEdit")
        self.gridLayout_2.addWidget(self.SaveFileLocLineEdit, 3, 1, 1, 1)
        ...
        self.tab_chain = QtWidgets.QWidget()
        self.tab_chain.setObjectName("tab_chain")
        self.gridLayout_9 = QtWidgets.QGridLayout(self.tab_chain)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.addRemoveBtnFrame = QtWidgets.QFrame(self.tab_chain)
        ...
        self.textEdit = QtWidgets.QTextEdit(self.tab_chain)
        self.textEdit.setObjectName("textEdit")
        self.gridLayout_9.addWidget(self.textEdit, 2, 0, 1, 1)
        self.chainTreeWidget = QtWidgets.QTreeWidget(self.tab_chain)
        self.chainTreeWidget.setObjectName("chainTreeWidget")
        self.gridLayout_9.addWidget(self.chainTreeWidget, 0, 0, 1, 1)
        self.mainTab.addTab(self.tab_chain, "")
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.tab_frq)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.saveFileLocLbl.setText(_translate("mainWindow", "Save file location"))
        self.genDataFileBtn.setText(_translate("mainWindow", "Confirm and generate file"))
        ...
        self.chainTreeWidget.headerItem().setText(0, _translate("mainWindow", "Sequence"))
        self.chainTreeWidget.headerItem().setText(1, _translate("mainWindow", "Repeats"))
        self.mainTab.setTabText(self.mainTab.indexOf(self.tab_chain), _translate("mainWindow", "Chain"))
